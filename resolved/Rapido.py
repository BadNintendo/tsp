...
def solve_tsp(cities):
    """Find and optimize a path using nearest neighbor heuristic and 2-opt algorithm."""
    def tsp_nearest_neighbor_and_optimize(cities):
    ...
    initial_solution = tsp_nearest_neighbor_and_optimize(cities)
